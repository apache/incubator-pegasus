...
{
    1:pegasus.gpid        parent_gpid;
    2:pegasus.gpid        child_gpid;
    3:i64                 child_ballot;
    4:pegasus.rpc_address child_address;
}
...
{
    1:pegasus.rpc_address target_address;
    2:i32                 new_partition_count;
    3:pegasus.gpid        child_pid;
    4:i64                 ballot;
}
...
struct register_child_request
{
    ...
    2:pegasus.layer2.partition_configuration    parent_config;
    3:pegasus.layer2.partition_configuration    child_config;
    4:pegasus.rpc_address                       primary_address;
}
...
struct register_child_response
{
    ...
    1:pegasus.error_code                        err;
    2:pegasus.layer2.app_info                   app;
    3:pegasus.layer2.partition_configuration    parent_config;
    4:pegasus.layer2.partition_configuration    child_config;
}
...
struct query_child_state_response
{
    ...
    3:optional pegasus.layer2.partition_configuration child_config;
}
