...
function(dsn_setup_packages)
	...
	set(DSN_LIBS ${DSN_LIBS} ${DSN_EXTRA_LIBS} ${DSN_SYSTEM_LIBS} CACHE STRING "rDSN libs" FORCE)
...
function(dsn_setup_install)
	if(DSN_BUILD_RUNTIME)
		...
		if(MSVC)
			...
			install(PROGRAMS "codegen/dsn.cg.sh" DESTINATION bin)
		endif()
	endif()
...
function(dsn_setup_runtime)
	set(DSN_BUILD_RUNTIME 1)
	dsn_common_setup()
	dsn_add_pseudo_projects()
	add_subdirectory(src)
endfunction(dsn_setup_runtime)