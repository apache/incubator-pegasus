...
var v1Tov2MetricsConversion = map[string]string{
	...
	"replica*app.pegasus*dup_retry_non_idempotent_duplicate_request":           "dup_retry_non_idempotent_duplicate_request",
	"replica*app.pegasus*dup_unsafe_received_non_idempotent_duplicate_request": "dup_unsafe_received_non_idempotent_duplicate_request",
