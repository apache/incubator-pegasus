...
public class multi_remove_response implements org.apache.thrift.TBase<multi_remove_response, multi_remove_response._Fields>, java.io.Serializable, Cloneable, Comparable<multi_remove_response> {
  ...
  static {
    schemes.put(StandardScheme.class, new multi_remove_responseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new multi_remove_responseTupleSchemeFactory());
  }
  ...
  public void unsetDecree() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __DECREE_ISSET_ID);
  }

  /** Returns true if field decree is set (has been assigned a value) and false otherwise */
  public boolean isSetDecree() {
    return EncodingUtils.testBit(__isset_bitfield, __DECREE_ISSET_ID);
  }

  public void setDecreeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __DECREE_ISSET_ID, value);
  }
  ...
  public multi_remove_response setServer(String server) {
    this.server = server;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_decree = true;
    list.add(present_decree);
    if (present_decree)
      list.add(decree);
  ...
  public int compareTo(multi_remove_response other) {
    ...
    lastComparison = Boolean.valueOf(isSetDecree()).compareTo(other.isSetDecree());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDecree()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("multi_remove_response(");
    boolean first = true;
  ...
  private static class multi_remove_responseStandardSchemeFactory implements SchemeFactory {
    public multi_remove_responseStandardScheme getScheme() {
      return new multi_remove_responseStandardScheme();
    }
  }

  private static class multi_remove_responseStandardScheme extends StandardScheme<multi_remove_response> {
  ...
  private static class multi_remove_responseTupleSchemeFactory implements SchemeFactory {
    public multi_remove_responseTupleScheme getScheme() {
      return new multi_remove_responseTupleScheme();
    }
  }

  private static class multi_remove_responseTupleScheme extends TupleScheme<multi_remove_response> {
