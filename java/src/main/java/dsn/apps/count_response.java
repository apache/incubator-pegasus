...
public class count_response implements org.apache.thrift.TBase<count_response, count_response._Fields>, java.io.Serializable, Cloneable, Comparable<count_response> {
  ...
  static {
    schemes.put(StandardScheme.class, new count_responseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new count_responseTupleSchemeFactory());
  }
  ...
  public count_response setServer(String server) {
    this.server = server;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("count_response(");
    boolean first = true;
  ...
  private static class count_responseStandardSchemeFactory implements SchemeFactory {
    public count_responseStandardScheme getScheme() {
      return new count_responseStandardScheme();
    }
  }

  private static class count_responseStandardScheme extends StandardScheme<count_response> {
  ...
  private static class count_responseTupleSchemeFactory implements SchemeFactory {
    public count_responseTupleScheme getScheme() {
      return new count_responseTupleScheme();
    }
  }

  private static class count_responseTupleScheme extends TupleScheme<count_response> {
