...
public class scan_response implements org.apache.thrift.TBase<scan_response, scan_response._Fields>, java.io.Serializable, Cloneable, Comparable<scan_response> {
  ...
  static {
    schemes.put(StandardScheme.class, new scan_responseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new scan_responseTupleSchemeFactory());
  }
  ...
  public scan_response setKvs(List<key_value> kvs) {
    this.kvs = kvs;
    return this;
  }
  ...
  public scan_response setServer(String server) {
    this.server = server;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("scan_response(");
    boolean first = true;
  ...
  private static class scan_responseStandardSchemeFactory implements SchemeFactory {
    public scan_responseStandardScheme getScheme() {
      return new scan_responseStandardScheme();
    }
  }

  private static class scan_responseStandardScheme extends StandardScheme<scan_response> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.kvs = new ArrayList<key_value>(_list32.size);
                key_value _elem33;
  ...
  private static class scan_responseTupleSchemeFactory implements SchemeFactory {
    public scan_responseTupleScheme getScheme() {
      return new scan_responseTupleScheme();
    }
  }

  private static class scan_responseTupleScheme extends TupleScheme<scan_response> {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.kvs = new ArrayList<key_value>(_list37.size);
          key_value _elem38;
