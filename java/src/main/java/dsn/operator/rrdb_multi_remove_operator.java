...
import dsn.apps.multi_remove_request;
import dsn.apps.multi_remove_response;
...
public class rrdb_multi_remove_operator extends client_operator {
    public rrdb_multi_remove_operator(dsn.base.gpid gpid, multi_remove_request request) {
        super(gpid);
