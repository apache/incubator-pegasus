...
macro(dsn_setup_serialization)
    set(USE_THRIFT FALSE)
    set(USE_PROTOBUF FALSE)
    if (DSN_BUILD_RUNTIME)
        if (DSN_SERIALIZATION_TYPE STREQUAL "thrift")
            set(USE_THRIFT TRUE)
        elseif (DSN_SERIALIZATION_TYPE STREQUAL "protobuf")
    ...
    if (MY_PROJ_LANG STREQUAL "CXX")
        if (USE_THRIFT)
            ...
            if (WIN32)
                ...
                list(APPEND MY_PROJ_LIBS libthrift)
            endif ()
...
function(dsn_add_project)
    ...
    if (DSN_BUILD_RUNTIME)
        ...
        if (USE_PROTOBUF)
            add_definitions(${MY_PROJ_NAME} protobuf)
        endif ()
    endif()
...
function(dsn_setup_git_source)
    if(NOT DEFINED DSN_GIT_SOURCE)
        set(DSN_GIT_SOURCE "github")
    endif()

    if(DSN_GIT_SOURCE STREQUAL "github")
        message(STATUS "use github git source")
    elseif(DSN_GIT_SOURCE STREQUAL "xiaomi")
        message(STATUS "use xiaomi git source")
    else()
        message(FATAL_ERROR "not support other git source")
    endif()
endfunction(dsn_setup_git_source)
