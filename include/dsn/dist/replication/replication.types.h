...
namespace dsn { namespace replication { 
    ...
    GENERATED_TYPE_SERIALIZATION(control_balancer_migration_request, THRIFT)
    GENERATED_TYPE_SERIALIZATION(control_balancer_migration_response, THRIFT)
    GENERATED_TYPE_SERIALIZATION(balancer_proposal_request, THRIFT)
    GENERATED_TYPE_SERIALIZATION(balancer_proposal_response, THRIFT)
