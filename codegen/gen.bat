...
SET CODEGEN_ONE=%CODEGEN_ROOT%gen_one.bat

CALL %CODEGEN_ONE% %CODEGEN_LIBS% cpp.code.definition.php %2 %1 > %3\%1.code.definition.h
ECHO %3\%1.code.definition.h is ready
CALL %CODEGEN_ONE% %CODEGEN_LIBS% cpp.client.php %2 %1 > %3\%1.client.h
