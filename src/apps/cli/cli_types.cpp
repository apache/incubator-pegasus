...
const char* command::ascii_fingerprint = "25702B8D5E28AA39160F267DABBC8446";
const uint8_t command::binary_fingerprint[16] = {0x25,0x70,0x2B,0x8D,0x5E,0x28,0xAA,0x39,0x16,0x0F,0x26,0x7D,0xAB,0xBC,0x84,0x46};
...
std::ostream& operator<<(std::ostream& out, const command& obj) {
  ...
  out << ", " << "arguments=" << to_string(obj.arguments);
  out << ")";
  return out;
}
