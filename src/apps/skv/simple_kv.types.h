...
namespace dsn {
    // ---------- kv_pair -------------
    template<>
    inline uint32_t marshall_base< ::dsn::replication::application::kv_pair>(::apache::thrift::protocol::TProtocol* oprot, const ::dsn::replication::application::kv_pair& val)
    {
        uint32_t xfer = 0;
    ...
    template<>
    inline uint32_t unmarshall_base< ::dsn::replication::application::kv_pair>(::apache::thrift::protocol::TProtocol* iprot, /*out*/ ::dsn::replication::application::kv_pair& val)
    {
        uint32_t xfer = 0;
        std::string fname;
