...
typedef struct _deploy_request__isset
{
    _deploy_request__isset()
        : info(false),
          package_full_path(false),
          package_server(false),
          cluster_name(false),
          name(false)
    {
    }
...
public:
    ...
    bool operator!=(const deploy_request &rhs) const { return !(*this == rhs); }
...
{
    _deploy_info__isset()
        : info(false), name(false), service_url(false), error(false), cluster(false), status(false)
    {
    }
    bool info : 1;
    bool name : 1;
...
public:
    ...
    bool operator!=(const deploy_info &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const deploy_info_list &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const cluster_info &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const cluster_list &rhs) const { return !(*this == rhs); }
