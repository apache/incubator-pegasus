...
int _kcluster_typeValues[] = {cluster_type::cstype_kubernetes,
...
const char *_kcluster_typeNames[] = {"cstype_kubernetes",
                                     "cstype_docker",
                                     ...
                                     "cstype_count",
                                     "cstype_invalid"};
const std::map<int, const char *> _cluster_type_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(10, _kcluster_typeValues, _kcluster_typeNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

int _kservice_statusValues[] = {service_status::SS_PREPARE_RESOURCE,
...
const char *_kservice_statusNames[] = {"SS_PREPARE_RESOURCE",
                                       "SS_DEPLOYING",
                                       "SS_RUNNING",
                                       "SS_FAILOVER",
                                       "SS_FAILED",
                                       ...
                                       "SS_COUNT",
                                       "SS_INVALID"};
const std::map<int, const char *> _service_status_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(9, _kservice_statusValues, _kservice_statusNames),
    ::apache::thrift::TEnumIterator(-1, NULL, NULL));

deploy_request::~deploy_request() throw() {}

void deploy_request::__set_info(const ::dsn::app_info &val) { this->info = val; }
...
void deploy_request::__set_cluster_name(const std::string &val) { this->cluster_name = val; }

void deploy_request::__set_name(const std::string &val) { this->name = val; }
...
void deploy_request::printTo(std::ostream &out) const
{
    ...
    out << ", "
        << "package_full_path=" << to_string(package_full_path);
    out << ", "
        << "package_server=" << to_string(package_server);
    out << ", "
...
void deploy_info::__set_info(const ::dsn::app_info &val) { this->info = val; }

void deploy_info::__set_name(const std::string &val) { this->name = val; }

void deploy_info::__set_service_url(const std::string &val) { this->service_url = val; }

void deploy_info::__set_error(const ::dsn::error_code &val) { this->error = val; }

void deploy_info::__set_cluster(const std::string &val) { this->cluster = val; }

void deploy_info::__set_status(const service_status::type val) { this->status = val; }
...
void deploy_info::printTo(std::ostream &out) const
{
    ...
    out << ", "
        << "name=" << to_string(name);
    out << ", "
        << "service_url=" << to_string(service_url);
    out << ", "
...
void deploy_info_list::__set_services(const std::vector<deploy_info> &val) { this->services = val; }
...
uint32_t deploy_info_list::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("services", ::apache::thrift::protocol::T_LIST, 1);
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->services.size()));
...
void cluster_info::__set_name(const std::string &val) { this->name = val; }

void cluster_info::__set_type(const cluster_type::type val) { this->type = val; }
...
void cluster_list::__set_clusters(const std::vector<cluster_info> &val) { this->clusters = val; }
...
uint32_t cluster_list::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->clusters.size()));
