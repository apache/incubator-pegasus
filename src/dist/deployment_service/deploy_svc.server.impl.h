...
public:
    ...
    virtual void on_undeploy(const std::string& service_name, ::dsn::rpc_replier<std::string>& reply) override;
...
private:
    void download_service_resource_completed(std::shared_ptr<::dsn::dist::deployment_unit> svc);
