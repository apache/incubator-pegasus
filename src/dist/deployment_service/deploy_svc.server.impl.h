...
class deploy_svc_service_impl : public deploy_svc_service
{
public:
    ...
    virtual void on_deploy(const deploy_request &req,
                           /*out*/ ::dsn::rpc_replier<deploy_info> &reply) override;

    virtual void on_undeploy(const std::string &service_name,
                             /*out*/ ::dsn::rpc_replier<error_code> &reply) override;

    virtual void on_get_service_list(const std::string &package_id,
                                     /*out*/ ::dsn::rpc_replier<deploy_info_list> &reply) override;

    virtual void on_get_service_info(const std::string &service_url,
                                     /*out*/ ::dsn::rpc_replier<deploy_info> &reply) override;

    virtual void on_get_cluster_list(const std::string &format,
                                     /*out*/ ::dsn::rpc_replier<cluster_list> &reply) override;
...
private:
    void download_service_resource_completed(error_code err,
                                             std::shared_ptr<::dsn::dist::deployment_unit> svc);
    ...
    void on_service_deployed(std::shared_ptr<::dsn::dist::deployment_unit> unit,
                             ::dsn::error_code err,
                             ::dsn::rpc_address addr);

    void on_service_failure(std::shared_ptr<::dsn::dist::deployment_unit> unit,
                            ::dsn::error_code err,
                            const std::string &err_msg);
    void on_service_undeployed(std::string service_name,
                               ::dsn::error_code err,
                               const std::string &err_msg);
    ...
    void on_get_service_list_internal(const std::string &package_id,
                                      /*out*/ deploy_info_list &dlist);
