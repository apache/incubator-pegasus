...
namespace dist {
// server app example
class deploy_svc_server_app : public ::dsn::service_app
{
public:
    deploy_svc_server_app(dsn_gpid gpid) : ::dsn::service_app(gpid) {}

    virtual ::dsn::error_code start(int argc, char **argv) { return _deploy_svc_svc.start(gpid()); }
...
// client app example
class deploy_svc_client_app : public ::dsn::service_app, public virtual ::dsn::clientlet
{
public:
    deploy_svc_client_app(dsn_gpid gpid) : ::dsn::service_app(gpid)
    {
        _deploy_svc_client = nullptr;
    }

    ~deploy_svc_client_app() { stop(); }
    ...
    virtual ::dsn::error_code start(int argc, char **argv)
    {
        ...
        _timer = ::dsn::tasking::enqueue_timer(
            LPC_DEPLOY_SVC_TEST_TIMER, this, [this] { on_test_timer(); }, std::chrono::seconds(1));
        return ::dsn::ERR_OK;
    }
    ...
    void on_test_timer()
    {
        // test for service 'deploy_svc'
        {
            ...
            std::cout << "call RPC_DEPLOY_SVC_DEPLOY_SVC_DEPLOY end, return "
        ...
        }
        {
            ...
            std::cout << "call RPC_DEPLOY_SVC_DEPLOY_SVC_UNDEPLOY end, return "
                      << result.first.to_string() << std::endl;
            // async:
        ...
        }
        {
            ...
            std::cout << "call RPC_DEPLOY_SVC_DEPLOY_SVC_GET_SERVICE_LIST end, return "
                      << result.first.to_string() << std::endl;
            // async:
        ...
        }
        {
            ...
            std::cout << "call RPC_DEPLOY_SVC_DEPLOY_SVC_GET_SERVICE_INFO end, return "
                      << result.first.to_string() << std::endl;
            // async:
        ...
        }
        {
            ...
            std::cout << "call RPC_DEPLOY_SVC_DEPLOY_SVC_GET_CLUSTER_LIST end, return "
                      << result.first.to_string() << std::endl;
            // async:
...
class deploy_svc_perf_test_client_app : public ::dsn::service_app, public virtual ::dsn::clientlet
{
public:
    deploy_svc_perf_test_client_app(dsn_gpid gpid) : ::dsn::service_app(gpid)
    {
        _deploy_svc_client = nullptr;
    }

    ~deploy_svc_perf_test_client_app() { stop(); }
