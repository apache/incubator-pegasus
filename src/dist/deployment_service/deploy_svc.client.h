...
namespace dsn {
namespace dist {
class deploy_svc_client : public virtual ::dsn::clientlet
{
public:
    ...
    // - synchronous
    std::pair<::dsn::error_code, deploy_info>
    deploy_sync(const deploy_request &args,
    ...
    ::dsn::task_ptr deploy(const deploy_request &args,
                           TCallback &&callback,
                           std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                           int thread_hash = 0,
                           uint64_t partition_hash = 0,
    ...
    // - synchronous
    std::pair<::dsn::error_code, ::dsn::error_code>
    undeploy_sync(const std::string &args,
                  std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                  int thread_hash = 0,
                  uint64_t partition_hash = 0,
                  dsn::optional<::dsn::rpc_address> server_addr = dsn::none)
    ...
    template <typename TCallback>
    ::dsn::task_ptr undeploy(const std::string &args,
                             TCallback &&callback,
                             std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                             int thread_hash = 0,
                             uint64_t partition_hash = 0,
    ...
    // - synchronous
    std::pair<::dsn::error_code, deploy_info_list>
    get_service_list_sync(const std::string &args,
                          std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                          int thread_hash = 0,
                          uint64_t partition_hash = 0,
                          dsn::optional<::dsn::rpc_address> server_addr = dsn::none)
    ...
    template <typename TCallback>
    ::dsn::task_ptr
    get_service_list(const std::string &args,
                     TCallback &&callback,
                     std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                     int thread_hash = 0,
                     uint64_t partition_hash = 0,
    ...
    // - synchronous
    std::pair<::dsn::error_code, deploy_info>
    get_service_info_sync(const std::string &args,
                          std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                          int thread_hash = 0,
                          uint64_t partition_hash = 0,
                          dsn::optional<::dsn::rpc_address> server_addr = dsn::none)
    ...
    template <typename TCallback>
    ::dsn::task_ptr
    get_service_info(const std::string &args,
                     TCallback &&callback,
                     std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                     int thread_hash = 0,
                     uint64_t partition_hash = 0,
    ...
    // - synchronous
    std::pair<::dsn::error_code, cluster_list>
    get_cluster_list_sync(const std::string &args,
                          std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                          int thread_hash = 0,
                          uint64_t partition_hash = 0,
                          dsn::optional<::dsn::rpc_address> server_addr = dsn::none)
    ...
    template <typename TCallback>
    ::dsn::task_ptr
    get_cluster_list(const std::string &args,
                     TCallback &&callback,
                     std::chrono::milliseconds timeout = std::chrono::milliseconds(0),
                     int thread_hash = 0,
                     uint64_t partition_hash = 0,
