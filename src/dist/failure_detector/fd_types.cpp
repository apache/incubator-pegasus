...
void beacon_msg::__set_time(const int64_t val) { this->time = val; }

void beacon_msg::__set_from_addr(const ::dsn::rpc_address &val) { this->from_addr = val; }

void beacon_msg::__set_to_addr(const ::dsn::rpc_address &val) { this->to_addr = val; }
...
void beacon_msg::printTo(std::ostream &out) const
{
    ...
    out << ", "
        << "from_addr=" << to_string(from_addr);
    out << ", "
        << "to_addr=" << to_string(to_addr);
    out << ", "
        << "start_time=";
...
void beacon_ack::__set_time(const int64_t val) { this->time = val; }

void beacon_ack::__set_this_node(const ::dsn::rpc_address &val) { this->this_node = val; }

void beacon_ack::__set_primary_node(const ::dsn::rpc_address &val) { this->primary_node = val; }

void beacon_ack::__set_is_master(const bool val) { this->is_master = val; }

void beacon_ack::__set_allowed(const bool val) { this->allowed = val; }
...
void beacon_ack::printTo(std::ostream &out) const
{
    ...
    out << "time=" << to_string(time);
    out << ", "
        << "this_node=" << to_string(this_node);
    out << ", "
        << "primary_node=" << to_string(primary_node);
    out << ", "
        << "is_master=" << to_string(is_master);
    out << ", "
...
void config_master_message::__set_master(const ::dsn::rpc_address &val) { this->master = val; }

void config_master_message::__set_is_register(const bool val) { this->is_register = val; }
...
void config_master_message::printTo(std::ostream &out) const
{
    ...
    out << ", "
        << "is_register=" << to_string(is_register);
    out << ")";
}
}
} // namespace
