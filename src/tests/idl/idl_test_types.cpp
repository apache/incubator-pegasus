...
void test_thrift_item::__set_bool_item(const bool val) {
  this->bool_item = val;
}

void test_thrift_item::__set_byte_item(const int8_t val) {
  this->byte_item = val;
}

void test_thrift_item::__set_i16_item(const int16_t val) {
  this->i16_item = val;
}

void test_thrift_item::__set_i32_item(const int32_t val) {
  this->i32_item = val;
}

void test_thrift_item::__set_i64_item(const int64_t val) {
  this->i64_item = val;
}

void test_thrift_item::__set_double_item(const double val) {
  this->double_item = val;
}

void test_thrift_item::__set_string_item(const std::string& val) {
  this->string_item = val;
}
...
uint32_t test_thrift_item::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->list_i32_item.size()));
    std::vector<int32_t> ::const_iterator _iter18;
    for (_iter18 = this->list_i32_item.begin(); _iter18 != this->list_i32_item.end(); ++_iter18)
    {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->set_i32_item.size()));
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->map_i32_item.size()));
...
void test_thrift_item::printTo(std::ostream& out) const {
  ...
  out << ", " << "byte_item=" << to_string(byte_item);
  out << ", " << "i16_item=" << to_string(i16_item);
  out << ", " << "i32_item=" << to_string(i32_item);
  out << ", " << "i64_item=" << to_string(i64_item);
  out << ", " << "double_item=" << to_string(double_item);
  out << ", " << "string_item=" << to_string(string_item);
  out << ", " << "list_i32_item=" << to_string(list_i32_item);
  out << ", " << "set_i32_item=" << to_string(set_i32_item);
  out << ", " << "map_i32_item=" << to_string(map_i32_item);
  out << ")";
}
