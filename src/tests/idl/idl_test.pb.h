...
public:
    ...
    const ::google::protobuf::RepeatedField<::google::protobuf::int32> &repeated_int32_item() const;
    ::google::protobuf::RepeatedField<::google::protobuf::int32> *mutable_repeated_int32_item();
...
private:
    ...
    ::google::protobuf::internal::MapField<::google::protobuf::int32,
                                           ::google::protobuf::int32,
                                           ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
                                           ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
                                           0>
...
// optional bool bool_item = 1;
inline void test_protobuf_item::clear_bool_item() { bool_item_ = false; }
...
// optional int32 int32_item = 2;
inline void test_protobuf_item::clear_int32_item() { int32_item_ = 0; }
...
// optional int64 int64_item = 3;
inline void test_protobuf_item::clear_int64_item() { int64_item_ = GOOGLE_LONGLONG(0); }
...
// optional uint32 uint32_item = 4;
inline void test_protobuf_item::clear_uint32_item() { uint32_item_ = 0u; }
...
// optional uint64 uint64_item = 5;
inline void test_protobuf_item::clear_uint64_item() { uint64_item_ = GOOGLE_ULONGLONG(0); }
...
// optional float float_item = 6;
inline void test_protobuf_item::clear_float_item() { float_item_ = 0; }
...
// optional double double_item = 7;
inline void test_protobuf_item::clear_double_item() { double_item_ = 0; }
...
// map<int32, int32> map_int32_item = 9;
inline int test_protobuf_item::map_int32_item_size() const { return map_int32_item_.size(); }
inline void test_protobuf_item::clear_map_int32_item() { map_int32_item_.Clear(); }
...
inline void test_protobuf_item::clear_repeated_int32_item() { repeated_int32_item_.Clear(); }
