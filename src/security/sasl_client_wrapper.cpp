...
{
    FAIL_POINT_INJECT_F("sasl_client_wrapper_init", [](std::string_view str) {
...
{
    FAIL_POINT_INJECT_F("sasl_client_wrapper_start", [](std::string_view str) {
        error_code err = error_code::try_get(str.data(), ERR_UNKNOWN);
        return error_s::make(err);
    });
...
{
    FAIL_POINT_INJECT_F("sasl_client_wrapper_step", [](std::string_view str) {
        error_code err = error_code::try_get(str.data(), ERR_UNKNOWN);
        return error_s::make(err);
    });
