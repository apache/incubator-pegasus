...
public:
    ...
    virtual pc_status cure(meta_view view, const gpid &gpid, configuration_proposal_action &action);
...
private:
    bool from_proposals(meta_view &view, const gpid &gpid, configuration_proposal_action &action);
    pc_status on_missing_primary(meta_view &view, const gpid &gpid);
    pc_status on_missing_secondary(meta_view &view, const gpid &gpid);
    pc_status on_redundant_secondary(meta_view &view, const gpid &gpid);
    ...
    bool in_black_list(rpc_address addr)
    {
    ...
    zrwlock_nr _black_list_lock; // [
    std::set<rpc_address> _assign_secondary_black_list;
    // ]
