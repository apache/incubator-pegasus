...
namespace dsn { namespace service { 
	...
	DEFINE_TASK_CODE(LPC_NFS_CLIENT_CLEAN_TIMER, ::dsn::TASK_PRIORITY_COMMON, THREAD_POOL_DEFAULT)

	DEFINE_TASK_CODE(WRITE_FILE, ::dsn::TASK_PRIORITY_COMMON, THREAD_POOL_DEFAULT)

	DEFINE_TASK_CODE(CONTINUE_COPY, ::dsn::TASK_PRIORITY_COMMON, THREAD_POOL_DEFAULT)
} } 
