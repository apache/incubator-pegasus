...
handle_t native_win_aio_provider::open(const char* file_name, int flag, int pmode)
{
...
error_code native_win_aio_provider::aio_internal(aio_task_ptr& aio_tsk, bool async, __out uint32_t* pbytes /*= nullptr*/)
{
