...
namespace pegasus {
std::unique_ptr<value_field> value_schema_v2::extract_field(string_view value,
...
blob value_schema_v2::extract_user_data(std::string &&value)
{
...
rocksdb::SliceParts value_schema_v2::generate_value(const value_params &params)
{
    ...
    data_output output(params.write_buf);
...
std::unique_ptr<value_field> value_schema_v2::extract_timestamp(string_view value)
{
...
std::unique_ptr<value_field> value_schema_v2::extract_time_tag(string_view value)
{
    data_input input(value);
    input.skip(sizeof(uint8_t));
