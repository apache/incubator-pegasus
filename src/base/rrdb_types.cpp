...
void batch_get_request::__set_keys(const std::vector<full_key> & val) {
  this->keys = val;
}
...
void full_key::__set_hash_key(const  ::dsn::blob& val) {
  this->hash_key = val;
}

void full_key::__set_sort_key(const  ::dsn::blob& val) {
  this->sort_key = val;
}
...
void batch_get_response::__set_error(const int32_t val) {
  this->error = val;
}

void batch_get_response::__set_data(const std::vector<full_data> & val) {
  this->data = val;
}

void batch_get_response::__set_app_id(const int32_t val) {
  this->app_id = val;
}

void batch_get_response::__set_partition_index(const int32_t val) {
  this->partition_index = val;
}

void batch_get_response::__set_server(const std::string& val) {
  this->server = val;
}
...
void full_data::__set_hash_key(const  ::dsn::blob& val) {
  this->hash_key = val;
}

void full_data::__set_sort_key(const  ::dsn::blob& val) {
  this->sort_key = val;
}

void full_data::__set_value(const  ::dsn::blob& val) {
  this->value = val;
}
...
uint32_t check_and_mutate_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("mutate_list", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    for (_iter125 = this->mutate_list.begin(); _iter125 != this->mutate_list.end(); ++_iter125)
    {
...
check_and_mutate_request& check_and_mutate_request::operator=(const check_and_mutate_request& other128) {
...
check_and_mutate_response& check_and_mutate_response::operator=(const check_and_mutate_response& other132) {
...
check_and_mutate_response& check_and_mutate_response::operator=(check_and_mutate_response&& other133) {
