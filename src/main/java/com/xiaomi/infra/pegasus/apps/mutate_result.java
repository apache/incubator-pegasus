...
public class mutate_result implements com.xiaomi.infra.pegasus.thrift.TBase<mutate_result, mutate_result._Fields>, java.io.Serializable, Cloneable, Comparable<mutate_result> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("mutate_result");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new mutate_resultStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new mutate_resultTupleSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(mutate_result.class, metaDataMap);
  }
  ...
  private static class mutate_resultStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public mutate_resultStandardScheme getScheme() {
      return new mutate_resultStandardScheme();
    }
  }

  private static class mutate_resultStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<mutate_result> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, mutate_result struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, mutate_result struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class mutate_resultTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public mutate_resultTupleScheme getScheme() {
      return new mutate_resultTupleScheme();
    }
  }

  private static class mutate_resultTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<mutate_result> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, mutate_result struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, mutate_result struct) throws com.xiaomi.infra.pegasus.thrift.TException {
