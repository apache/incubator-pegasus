...
public class get_scanner_request implements com.xiaomi.infra.pegasus.thrift.TBase<get_scanner_request, get_scanner_request._Fields>, java.io.Serializable, Cloneable, Comparable<get_scanner_request> {
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField NEED_CHECK_HASH_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("need_check_hash", com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL, (short)11);
  ...
  static {
    ...
    tmpMap.put(_Fields.SORT_KEY_FILTER_PATTERN, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("sort_key_filter_pattern", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.StructMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, com.xiaomi.infra.pegasus.base.blob.class)));
    tmpMap.put(_Fields.NEED_CHECK_HASH, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("need_check_hash", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.OPTIONAL, 
        new com.xiaomi.infra.pegasus.thrift.meta_data.FieldValueMetaData(com.xiaomi.infra.pegasus.thrift.protocol.TType.BOOL)));
  ...
  public void unsetNeed_check_hash() {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.clearBit(__isset_bitfield, __NEED_CHECK_HASH_ISSET_ID);
  }
  ...
  public boolean isSetNeed_check_hash() {
    return com.xiaomi.infra.pegasus.thrift.EncodingUtils.testBit(__isset_bitfield, __NEED_CHECK_HASH_ISSET_ID);
  }

  public void setNeed_check_hashIsSet(boolean value) {
    __isset_bitfield = com.xiaomi.infra.pegasus.thrift.EncodingUtils.setBit(__isset_bitfield, __NEED_CHECK_HASH_ISSET_ID, value);
  }
  ...
  public int compareTo(get_scanner_request other) {
    ...
    if (isSetNeed_check_hash()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.need_check_hash, other.need_check_hash);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
