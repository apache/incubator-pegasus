...
public class scan_response implements com.xiaomi.infra.pegasus.thrift.TBase<scan_response, scan_response._Fields>, java.io.Serializable, Cloneable, Comparable<scan_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("scan_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField CONTEXT_ID_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("context_id", com.xiaomi.infra.pegasus.thrift.protocol.TType.I64, (short)3);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField APP_ID_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("app_id", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)4);
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField PARTITION_INDEX_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("partition_index", com.xiaomi.infra.pegasus.thrift.protocol.TType.I32, (short)5);
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new scan_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new scan_responseTupleSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(scan_response.class, metaDataMap);
  }
  ...
  private static class scan_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public scan_responseStandardScheme getScheme() {
      return new scan_responseStandardScheme();
    }
  }

  private static class scan_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<scan_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, scan_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KVS
            if (schemeField.type == com.xiaomi.infra.pegasus.thrift.protocol.TType.LIST) {
              {
                com.xiaomi.infra.pegasus.thrift.protocol.TList _list40 = iprot.readListBegin();
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, scan_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class scan_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public scan_responseTupleScheme getScheme() {
      return new scan_responseTupleScheme();
    }
  }

  private static class scan_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<scan_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, scan_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, scan_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          com.xiaomi.infra.pegasus.thrift.protocol.TList _list45 = new com.xiaomi.infra.pegasus.thrift.protocol.TList(com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, iprot.readI32());
