            ...
            if (schemeField.type == com.xiaomi.infra.pegasus.thrift.protocol.TType.LIST) {
              {
                ...
                struct.kvs = new java.util.ArrayList<key_value>(_list32.size);
                key_value _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new key_value();
                  _elem33.read(iprot);
                  struct.kvs.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, scan_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      if (struct.kvs != null) {
        oprot.writeFieldBegin(KVS_FIELD_DESC);
        {
          ...
          for (key_value _iter35 : struct.kvs)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetKvs()) {
        {
          ...
          for (key_value _iter36 : struct.kvs)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.kvs = new java.util.ArrayList<key_value>(_list37.size);
          key_value _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new key_value();
            _elem38.read(iprot);
            struct.kvs.add(_elem38);
          }
        }
        struct.setKvsIsSet(true);
      }
