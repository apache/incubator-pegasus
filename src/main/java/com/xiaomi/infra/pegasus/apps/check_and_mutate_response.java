...
public class check_and_mutate_response implements com.xiaomi.infra.pegasus.thrift.TBase<check_and_mutate_response, check_and_mutate_response._Fields>, java.io.Serializable, Cloneable, Comparable<check_and_mutate_response> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("check_and_mutate_response");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new check_and_mutate_responseStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new check_and_mutate_responseTupleSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(check_and_mutate_response.class, metaDataMap);
  }
  ...
  private static class check_and_mutate_responseStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_mutate_responseStandardScheme getScheme() {
      return new check_and_mutate_responseStandardScheme();
    }
  }

  private static class check_and_mutate_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<check_and_mutate_response> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, check_and_mutate_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, check_and_mutate_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class check_and_mutate_responseTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public check_and_mutate_responseTupleScheme getScheme() {
      return new check_and_mutate_responseTupleScheme();
    }
  }

  private static class check_and_mutate_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<check_and_mutate_response> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_mutate_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, check_and_mutate_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
