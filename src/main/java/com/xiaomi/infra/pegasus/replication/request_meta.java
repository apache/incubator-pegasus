...
public class request_meta implements org.apache.thrift.TBase<request_meta, request_meta._Fields>, java.io.Serializable, Cloneable, Comparable<request_meta> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("request_meta");
  ...
  private static final org.apache.thrift.protocol.TField PARTITION_INDEX_FIELD_DESC = new org.apache.thrift.protocol.TField("partition_index", org.apache.thrift.protocol.TType.I32, (short)2);
  private static final org.apache.thrift.protocol.TField CLIENT_TIMEOUT_FIELD_DESC = new org.apache.thrift.protocol.TField("client_timeout", org.apache.thrift.protocol.TType.I32, (short)3);
  private static final org.apache.thrift.protocol.TField PARTITION_HASH_FIELD_DESC = new org.apache.thrift.protocol.TField("partition_hash", org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField IS_BACKUP_REQUEST_FIELD_DESC = new org.apache.thrift.protocol.TField("is_backup_request", org.apache.thrift.protocol.TType.BOOL, (short)5);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new request_metaStandardSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(_Fields.PARTITION_INDEX, new org.apache.thrift.meta_data.FieldMetaData("partition_index", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.CLIENT_TIMEOUT, new org.apache.thrift.meta_data.FieldMetaData("client_timeout", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.PARTITION_HASH, new org.apache.thrift.meta_data.FieldMetaData("partition_hash", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.IS_BACKUP_REQUEST, new org.apache.thrift.meta_data.FieldMetaData("is_backup_request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public void unsetClient_timeout() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CLIENT_TIMEOUT_ISSET_ID);
  }
  ...
  public void setClient_timeoutIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CLIENT_TIMEOUT_ISSET_ID, value);
  }
  ...
  public void unsetPartition_hash() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PARTITION_HASH_ISSET_ID);
  }
  ...
  public void setPartition_hashIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PARTITION_HASH_ISSET_ID, value);
  }
  ...
  public void unsetIs_backup_request() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_BACKUP_REQUEST_ISSET_ID);
  }
  ...
  public void setIs_backup_requestIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_BACKUP_REQUEST_ISSET_ID, value);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof request_meta)
      return this.equals((request_meta)that);
    return false;
  }
  ...
  public boolean equals(request_meta that) {
    ...
    if (this_present_client_timeout || that_present_client_timeout) {
      if (!(this_present_client_timeout && that_present_client_timeout))
        return false;
      if (this.client_timeout != that.client_timeout)
        return false;
    }
    ...
    if (this_present_partition_hash || that_present_partition_hash) {
      if (!(this_present_partition_hash && that_present_partition_hash))
        return false;
      if (this.partition_hash != that.partition_hash)
        return false;
    }
    ...
    if (this_present_is_backup_request || that_present_is_backup_request) {
      if (!(this_present_is_backup_request && that_present_is_backup_request))
        return false;
      if (this.is_backup_request != that.is_backup_request)
        return false;
    }
  ...
  public int compareTo(request_meta other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetClient_timeout()).compareTo(other.isSetClient_timeout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClient_timeout()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.client_timeout, other.client_timeout);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetPartition_hash()).compareTo(other.isSetPartition_hash());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartition_hash()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.partition_hash, other.partition_hash);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetIs_backup_request()).compareTo(other.isSetIs_backup_request());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_backup_request()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_backup_request, other.is_backup_request);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class request_metaStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public request_metaStandardScheme getScheme() {
      return new request_metaStandardScheme();
    }
  }

  private static class request_metaStandardScheme extends org.apache.thrift.scheme.StandardScheme<request_meta> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, request_meta struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, request_meta struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class request_metaTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public request_metaTupleScheme getScheme() {
      return new request_metaTupleScheme();
    }
  }

  private static class request_metaTupleScheme extends org.apache.thrift.scheme.TupleScheme<request_meta> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, request_meta struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, request_meta struct) throws org.apache.thrift.TException {
