...
public class query_cfg_response implements com.xiaomi.infra.pegasus.thrift.TBase<query_cfg_response, query_cfg_response._Fields>, java.io.Serializable, Cloneable, Comparable<query_cfg_response> {
  ...
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TField FORWARD_ADDRESS_FIELD_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TField("forward_address", com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT, (short)6);
  ...
  public com.xiaomi.infra.pegasus.base.rpc_address forward_address; // required
  ...
  public enum _Fields implements com.xiaomi.infra.pegasus.thrift.TFieldIdEnum {
    ...
    FORWARD_ADDRESS((short)6, "forward_address");
  ...
  static {
    ...
    tmpMap.put(_Fields.FORWARD_ADDRESS, new com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData("forward_address", com.xiaomi.infra.pegasus.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public query_cfg_response(
    ...
    com.xiaomi.infra.pegasus.base.rpc_address forward_address)
  {
    this();
    this.err = err;
    this.app_id = app_id;
  ...
  public query_cfg_response(query_cfg_response other) {
    ...
    if (other.isSetForward_address()) {
      this.forward_address = new com.xiaomi.infra.pegasus.base.rpc_address(other.forward_address);
    }
  }
  ...
  public com.xiaomi.infra.pegasus.base.rpc_address getForward_address() {
    return this.forward_address;
  }

  public query_cfg_response setForward_address(com.xiaomi.infra.pegasus.base.rpc_address forward_address) {
    this.forward_address = forward_address;
    return this;
  }

  public void unsetForward_address() {
    this.forward_address = null;
  }

  /** Returns true if field forward_address is set (has been assigned a value) and false otherwise */
  public boolean isSetForward_address() {
    return this.forward_address != null;
  }

  public void setForward_addressIsSet(boolean value) {
    if (!value) {
      this.forward_address = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FORWARD_ADDRESS:
      if (value == null) {
        unsetForward_address();
      } else {
        setForward_address((com.xiaomi.infra.pegasus.base.rpc_address)value);
      }
      break;
  ...
  public boolean equals(query_cfg_response that) {
    ...
    boolean this_present_forward_address = true && this.isSetForward_address();
    boolean that_present_forward_address = true && that.isSetForward_address();
    if (this_present_forward_address || that_present_forward_address) {
      if (!(this_present_forward_address && that_present_forward_address))
        return false;
      if (!this.forward_address.equals(that.forward_address))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetForward_address()) ? 131071 : 524287);
    if (isSetForward_address())
      hashCode = hashCode * 8191 + forward_address.hashCode();
  ...
  public int compareTo(query_cfg_response other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetForward_address()).compareTo(other.isSetForward_address());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetForward_address()) {
      lastComparison = com.xiaomi.infra.pegasus.thrift.TBaseHelper.compareTo(this.forward_address, other.forward_address);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("forward_address:");
    if (this.forward_address == null) {
      sb.append("null");
    } else {
      sb.append(this.forward_address);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class query_cfg_responseStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<query_cfg_response> {
    ...
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, query_cfg_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // FORWARD_ADDRESS
            if (schemeField.type == com.xiaomi.infra.pegasus.thrift.protocol.TType.STRUCT) {
              struct.forward_address = new com.xiaomi.infra.pegasus.base.rpc_address();
              struct.forward_address.read(iprot);
              struct.setForward_addressIsSet(true);
            } else { 
              com.xiaomi.infra.pegasus.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, query_cfg_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      if (struct.forward_address != null) {
        oprot.writeFieldBegin(FORWARD_ADDRESS_FIELD_DESC);
        struct.forward_address.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class query_cfg_responseTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<query_cfg_response> {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, query_cfg_response struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      ...
      if (struct.isSetForward_address()) {
        optionals.set(5);
      }
