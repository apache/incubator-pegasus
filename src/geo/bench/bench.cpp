...
int main(int argc, char **argv)
{
    ...
    if (gen_data) {
        const geo::latlng_codec &codec = my_geo.get_codec();
    ...
    for (int i = 0; i < test_count; ++i) {
        ...
        my_geo.async_search_radial(
            ...
            500,
            [&, start_nanos](int error_code, std::list<geo::SearchResult> &&results) {
