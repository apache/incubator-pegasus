...
static const char *hash_key_prefix = "upgrade_test_hash_key_";
static const char *sort_key_prefix = "upgrade_test_sort_key_";
static const char *value_prefix = "upgrade_test_value_";
