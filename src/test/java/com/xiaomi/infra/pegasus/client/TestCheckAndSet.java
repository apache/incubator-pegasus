...
public class TestCheckAndSet {
    ...
    public void testValueNotExist() throws PException {
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    "k1".getBytes(), CheckType.CT_VALUE_NOT_EXIST, null,
                    "k1".getBytes(), "v2".getBytes(), options);
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    "k2".getBytes(), CheckType.CT_VALUE_NOT_EXIST, null,
                    "k2".getBytes(), "v2".getBytes(), options);
            Assert.assertFalse(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k4".getBytes(), "v4".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertFalse(result.checkValueExist);
    ...
    public void testMatchAnywhere() throws PException {
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k1".getBytes(), "v111v".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k1".getBytes(), "v3".getBytes(), options);
            Assert.assertFalse(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("v2".getBytes(), result.checkValue);
    ...
    public void testBytesCompare() throws PException {
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "v2".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("v1".getBytes(), result.checkValue);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "v3".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("v2".getBytes(), result.checkValue);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "v4".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("v3".getBytes(), result.checkValue);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "v5".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    "k5".getBytes(), CheckType.CT_VALUE_BYTES_GREATER_OR_EQUAL, "v4".getBytes(),
                    "k5".getBytes(), "v6".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "v7".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
    ...
    public void testIntCompare() throws PException {
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k1".getBytes(), "2".getBytes(), options);
            Assert.assertFalse(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertFalse(result.checkValueExist);
            value = client.get(tableName, hashKey, "k1".getBytes());
            ...
            options.returnCheckValue = true;
            try {
                client.checkAndSet(tableName, hashKey,
                        "k1".getBytes(), CheckType.CT_VALUE_INT_EQUAL, "1".getBytes(),
                        "k1".getBytes(), "2".getBytes(), options);
                Assert.assertTrue(false);
            } catch (PException ex) {
            ...
            try {
                client.checkAndSet(tableName, hashKey,
                        ...
                        "k1".getBytes(), "3".getBytes(), options);
                Assert.assertTrue(false);
            } catch (PException ex) {
                Assert.assertTrue(ex.getMessage(), ex.getMessage().endsWith("rocksdb error: 4"));
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k1".getBytes(), "-1".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k4".getBytes(), "4".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
        ...
        try {
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "2".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("1".getBytes(), result.checkValue);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "3".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "4".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            Assert.assertArrayEquals("3".getBytes(), result.checkValue);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "5".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    "k5".getBytes(), CheckType.CT_VALUE_INT_GREATER_OR_EQUAL, "4".getBytes(),
                    "k5".getBytes(), "6".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
            ...
            result = client.checkAndSet(tableName, hashKey,
                    ...
                    "k5".getBytes(), "7".getBytes(), options);
            Assert.assertTrue(result.setSucceed);
            Assert.assertTrue(result.checkValueReturned);
            Assert.assertTrue(result.checkValueExist);
    ...
    public void testCompareExchange() throws PException {
        ...
        try {
            ...
            result = client.compareExchange(tableName, hashKey, "k1".getBytes(), "".getBytes(), "v1".getBytes(), 0);
            Assert.assertFalse(result.setSucceed);
            ...
            result = client.compareExchange(tableName, hashKey, "k1".getBytes(), "".getBytes(), "v2".getBytes(), 0);
            Assert.assertFalse(result.setSucceed);
            Assert.assertArrayEquals("v1".getBytes(), result.actualValue);
            value = client.get(tableName, hashKey, "k1".getBytes());
            Assert.assertArrayEquals("v1".getBytes(), value);

            result = client.compareExchange(tableName, hashKey, "k1".getBytes(), "v1".getBytes(), "v2".getBytes(), 0);
            Assert.assertTrue(result.setSucceed);
            Assert.assertNull(result.actualValue);
            value = client.get(tableName, hashKey, "k1".getBytes());
            Assert.assertArrayEquals("v2".getBytes(), value);
