...
config::config() {
    ...
    _benchmarks = dsn_config_get_value_string(
            "pegasus.benchmark", "benchmarks", "", "");
    ...
    _batch_size = (int32_t)dsn_config_get_value_uint64(
            "pegasus.benchmark", "batch_size", 0, "Batch size");
    ...
    _compression_ratio = dsn_config_get_value_double(
            "pegasus.benchmark", "compression_ratio", 0,
    ...
    _enable_numa = (int32_t)dsn_config_get_value_bool(
            "pegasus.benchmark", "enable_numa", true, "");
    ...
    _stats_interval = dsn_config_get_value_uint64(
            "pegasus.benchmark", "stats_interval", 0,
    ...
    _report_interval_seconds = dsn_config_get_value_uint64(
            "pegasus.benchmark", "report_interval_seconds", 0,
            "If greater than zero, it will write simple stats in CVS format to --report_file every N seconds");
    _report_file = dsn_config_get_value_string(
            "pegasus.benchmark", "report_file", "",
            "Filename where some simple stats are reported to (if --report_interval_seconds is bigger than 0)");
    _thread_status_per_interval = (int32_t)dsn_config_get_value_uint64(
            "pegasus.benchmark", "thread_status_per_interval", 0,
    ...
    _benchmark_write_rate_limit = dsn_config_get_value_uint64(
            "pegasus.benchmark", "benchmark_write_rate_limit", 0,
            "If non-zero, db_bench will rate-limit the writes going into RocksDB. This is the global rate in bytes/second");
    _benchmark_read_rate_limit = dsn_config_get_value_uint64(
            "pegasus.benchmark", "benchmark_read_rate_limit", 0,
            "If non-zero, db_bench will rate-limit the reads from RocksDB. This is the global rate in ops/second");
    _prefix_size = (int32_t)dsn_config_get_value_uint64(
            "pegasus.benchmark", "prefix_size", 0,
