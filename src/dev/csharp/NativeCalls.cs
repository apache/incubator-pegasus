...
namespace dsn.dev.csharp
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void dsn_rpc_request_handler_t(dsn_message_t request, System.IntPtr param);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void dsn_rpc_response_handler_t(dsn_error_t err, dsn_message_t req, dsn_message_t resp, System.IntPtr param);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void dsn_aio_handler_t(dsn_error_t err, size_t sz, System.IntPtr param);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate System.IntPtr dsn_app_create(); // return app_context
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate dsn_error_t dsn_app_start(System.IntPtr app_context, int argc, string[] argv);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void dsn_app_destroy(System.IntPtr app_context, bool cleanup);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    // TODO: dsn_app_info[]
    public delegate System.IntPtr dsn_checker_create(string name, dsn_app_info[] app_info, int app_info_count);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void dsn_checker_apply(System.IntPtr checker);
    ...
    public struct dsn_app_info
    {
        ...
        public byte[] type; // size = DSN_MAX_APP_TYPE_NAME_LENGTH

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
        public byte[] name; // size = DSN_MAX_APP_TYPE_NAME_LENGTH
    };
    ...
    public static class Native
    {
        ...
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
        public extern static string                dsn_error_to_string(dsn_error_t err);    
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
        public extern static dsn_threadpool_code_t dsn_threadpool_code_register(string name);
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
        public extern static string                dsn_threadpool_code_to_string(dsn_threadpool_code_t pool_code);
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
        public extern static string                dsn_task_code_to_string(dsn_task_code_t code);
        [DllImport(DSN_CORE_DLL, CallingConvention=CallingConvention.Cdecl)]
