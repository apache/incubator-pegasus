...
public class batch_get_request
    implements org.apache.thrift.TBase<batch_get_request, batch_get_request._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<batch_get_request> {
  ...
  public batch_get_request(java.util.List<full_key> keys) {
    this();
    this.keys = keys;
  }
  ...
  private static class batch_get_requestStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<batch_get_request> {
  ...
  private static class batch_get_requestTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<batch_get_request> {
