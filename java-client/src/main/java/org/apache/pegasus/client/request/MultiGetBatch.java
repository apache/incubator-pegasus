...
public class MultiGetBatch
    extends BatchWithResponse<MultiGet, PegasusTableInterface.MultiGetResult> {
  ...
  @Override
  protected Future<PegasusTableInterface.MultiGetResult> asyncCommit(MultiGet multiGet) {
